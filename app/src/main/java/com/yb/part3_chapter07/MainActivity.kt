...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, Overlay.OnClickListener {
    ...
    private val viewPager2: ViewPager2 by lazy { findViewById(R.id.houseViewPager) }
    ...
    private val houseListRecyclerView: RecyclerView by lazy { findViewById(R.id.houseListRecyclerView) }
    ...
    private val bottomSheetTitleTextView: TextView by lazy { findViewById(R.id.bottomSheetTitle) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        houseListRecyclerView.adapter = houseListAdapter
    ...
    override fun onMapReady(map: NaverMap) {
        ...
        uiSetting.setLogoMargin(10, 0, 0, dpToPx(this, 80))
            ...
            houseService.getHouseList().enqueue(object : Callback<HouseDTO> {
                override fun onResponse(call: Call<HouseDTO>, response: Response<HouseDTO>) {
                    ...
                    response.body()?.let { houseDTO ->
                        updateMarker(houseDTO)
                        viewPagerAdapter.submitList(houseDTO.items)
                        houseListAdapter.submitList(houseDTO.items)
    ...
    private fun updateMarker(houseDTO: HouseDTO) {
